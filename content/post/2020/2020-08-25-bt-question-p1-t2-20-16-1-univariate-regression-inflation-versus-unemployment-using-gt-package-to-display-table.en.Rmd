...
BT is already known for our tough practice questions, but I wanted to take it further and add more realism. I've been writing a fresh set of questions on the regression topic (I'm always writing new questions!). It takes more time, but in these regression sets I've been pulling actual datasets. In combination with actual code-based applications, these new question sets are much more **realistic** than typical exam-prep fare. Let's face it: in the real world, quantitative tasks (e.g., regression) are performed in software, not with calculators. In a way, it's my responsibility to help candidates get exposure to the tools that are actually useful. We've long been the only FRM EPP who engages all of the FRM broad array of quantitative topics with spreadsheet workbook (a massive construction that's taken me the better part of a decade). Now we'll be the only FRM EPP who serves candidates actual code-based practice questions.

My first question in the new regression set reads as follows:
