...
BT is already known for our tough practice questions, but I wanted to take it a step further and add more realism. I've been writing a fresh set of questions on the regression topic (I'm always writing new questions!). It takes more time, but in these regression sets I've been pulling actual datasets. In combination with actual code-based applications, these question sets are much more **realistic** than your typical exam prep fare. Let's face it: in the real world, these quantitative tasks (e.g., regression) are performed in software, not with calculators. In a way, it's my responsibility to help candidates get exposure to the tools that are useful. We've long been the only FRM EPP who engages all the quantitative topics with spreadsheet (a construction that's taken me the better part of a decade); now we'll be the only FRM EPP who serves you actual code-based practice questions.
